import { FacebookIcon, FacebookShareButton, LinkedinIcon, LinkedinShareButton, TwitterIcon, TwitterShareButton, TelegramIcon, TelegramShareButton, DiscordIcon, DiscordShareButton } from 'react-share';
...
export default function ShareWidget({ title, slug }: ShareWidgetProps) {
  ...
  return (
    <Wrapper>
      ...
      <TelegramShareButton title={shareMessage} url={currentUrl}>
        <TelegramIcon />
      </TelegramShareButton>
      <DiscordShareButton title={shareMessage} url={currentUrl}>
        <DiscordIcon />
      </DiscordShareButton>
    </Wrapper>
  );
