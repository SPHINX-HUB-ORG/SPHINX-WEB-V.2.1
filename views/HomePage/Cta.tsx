...
export default function Cta() {
  return (
    <CtaWrapper>
      <Container>
        <Stack>
          <OverTitle>Contributing</OverTitle>
          <SectionTitle>Want to contribute in post-quantum blockchain ecosystems?</SectionTitle>
          <Description>
          ...
          <ButtonGroup>
            <NextLink href="https://github.com/SPHINX-HUB-ORG/SPHINX-V2.1" passHref>
              <Button>
                Join our github <span>&rarr;</span>
              </Button>
            </NextLink>
          </ButtonGroup>
        </Stack>
