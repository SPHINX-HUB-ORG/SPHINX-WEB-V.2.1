...
var matches = typeof Element === 'undefined' ? () => false : Element.prototype.matches || // @ts-ignore
...
var isNodeMatchingSelectorFocusable = node => !(node.disabled || isInput(node) && node.type === 'hidden' || // offsetParent being null will allow detecting cases where an element
