 ...
 */
export declare const normalizeIndentListNotIndented: <V extends Value>(editor: TEditor<V>, [node, path]: TNodeEntry<import("@udecode/plate-core").TNode>) => true | undefined;
