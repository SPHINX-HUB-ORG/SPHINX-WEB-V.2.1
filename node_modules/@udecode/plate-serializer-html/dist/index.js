...
const createElementWithSlate = slateProps => {
  const {
    editor = plateCore.withTReact(plateCore.createTEditor()),
    value = [],
    onChange = () => {},
    children,
    ...props
...
const elementToHtml = (editor, {
  ...
  props = plateCore.pipeInjectProps(editor, props); // Search for matching plugin based on element type
  ...
  editor.plugins.some(plugin => {
    ...
    html = htmlEntities.decode(server.renderToStaticMarkup(createElementWithSlate({ ...slateProps,
      children: (_plugin$serializeHtml = (_plugin$serializeHtml2 = plugin.serializeHtml) === null || _plugin$serializeHtml2 === void 0 ? void 0 : _plugin$serializeHtml2.call(plugin, props)) !== null && _plugin$serializeHtml !== void 0 ? _plugin$serializeHtml : plateCore.pluginRenderElement(editor, plugin)(props)
    })));
...
const leafToHtml = (editor, {
  ...
  return editor.plugins.reduce((result, plugin) => {
    ...
    props = { ...plateCore.pipeInjectProps(editor, props),
      children: result
    };
    const serialized = (_plugin$serializeHtml = (_plugin$serializeHtml2 = plugin.serializeHtml) === null || _plugin$serializeHtml2 === void 0 ? void 0 : _plugin$serializeHtml2.call(plugin, props)) !== null && _plugin$serializeHtml !== void 0 ? _plugin$serializeHtml : plateCore.pluginRenderLeaf(editor, plugin)(props);
