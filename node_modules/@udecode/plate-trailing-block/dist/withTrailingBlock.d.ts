 ...
 */
export declare const withTrailingBlock: <V extends Value = Value, E extends PlateEditor<V> = PlateEditor<V>>(editor: E, { type, options: { level, ...query }, }: WithPlatePlugin<TrailingBlockPlugin, V, E>) => E;
