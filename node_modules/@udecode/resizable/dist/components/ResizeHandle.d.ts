...
export declare type ResizeHandleProps = HTMLPropsAs<'div'> & {
...
export declare const useResizeHandleProps: ({ direction, width, startMargin, endMargin, zIndex, onResize, onMouseDown, onTouchStart, onHover, onHoverEnd, style, ...props }: ResizeHandleProps) => {
    as?: any;
    asAlias?: any;
    ...
    style: {
        ...
        zIndex: number | "inherit" | (string & {}) | "-moz-initial" | "initial" | "revert" | "revert-layer" | "unset" | "auto";
...
export declare const ResizeHandle: import("@udecode/plate-common").Component<ResizeHandleProps>;
