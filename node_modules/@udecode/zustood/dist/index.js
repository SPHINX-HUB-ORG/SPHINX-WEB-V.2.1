...
const immerMiddleware = config => (set, get, api) => {
  const setState = (fn, actionName) => set(produce__default["default"](fn), true, actionName);
...
const createStore = name => (initialState, options = {}) => {
  ...
  if (persist !== null && persist !== void 0 && persist.enabled) {
    ...
    const options = { ...persist,
      name: (_persist$name = persist.name) !== null && _persist$name !== void 0 ? _persist$name : name
    };
    middlewares.push(config => middleware.persist(config, options));
  }
  ...
  const useTrackedStore = reactTracked.createTrackedSelector(useStore);
