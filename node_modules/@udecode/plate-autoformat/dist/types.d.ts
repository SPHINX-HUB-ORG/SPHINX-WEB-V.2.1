...
export declare type AutoformatRule<V extends Value = Value, E extends PlateEditor<V> = PlateEditor<V>> = AutoformatBlockRule<V, E> | AutoformatMarkRule<V, E> | AutoformatTextRule<V, E>;
