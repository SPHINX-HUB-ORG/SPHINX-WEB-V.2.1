...
export declare type FrequentEmojis = Record<string, number>;
export declare type FrequentEmojiStorageProps = {
    prefix?: string;
    key?: string;
    limit?: number;
};
...
//# sourceMappingURL=EmojiFloatingLibrary.types.d.ts.map