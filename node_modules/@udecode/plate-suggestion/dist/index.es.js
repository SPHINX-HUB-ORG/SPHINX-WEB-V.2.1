...
const SuggestionProvider = ({
  ...
  return /*#__PURE__*/r$2.createElement(JotaiProvider, {
...
const InjectSuggestion = props => {
  ...
  if (element[MARK_SUGGESTION]) {
    return ({
      children
    }) => /*#__PURE__*/r$2.createElement(_StyledDiv, {
...
const deleteSuggestion = (editor, at, {
  ...
  withoutNormalizing(editor, () => {
    ...
    while (true) {
      ...
      range = unhangCharacterRange(editor, range); // if the current point is in block addition suggestion, delete block
...
const withSuggestion = (e, plugin) => {
  ...
  editor.normalizeNode = entry => {
    ...
    if (node[MARK_SUGGESTION]) {
      const pointBefore = getPointBefore(editor, path); // Merge with previous suggestion
