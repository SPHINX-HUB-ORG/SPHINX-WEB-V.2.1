 ...
 */
export declare const unhangRange: <V extends Value>(editor: TEditor<V>, range?: Path | import("slate").BaseRange | import("slate").BasePoint | Span | null | undefined, options?: UnhangRangeOptions) => import("slate").BaseRange | undefined;
