 ...
 */
export declare type AsProps<T extends As = As> = {
    as?: T;
    asChild?: boolean;
};
/**
...
export declare type HTMLPropsAs<T extends As = any> = AsProps<T> & HTMLProps<AsProps<T>>;
/**
...
export declare type Component<O extends AsProps> = {
    <T extends As = NonNullable<O['as']>>(props: Omit<O, 'as'> & Omit<HTMLProps<AsProps<T>>, keyof O> & AsProps<T>): JSX.Element | null;
